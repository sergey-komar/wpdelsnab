                  ...
                  <div class="filter">
                    ...
                    <div class="ograshdenia-box__info">
                        <div class="ograshdenia-box__item">
                          <img src="./images/ograshdenia/ograshdenia-1.jpg" alt="img" class="ograshdenia-box__item-img">
                          <div class="ograshdenia-box__item-text">
                            Ограждение из нержавеющей стали с 2 ригелями
                          </div>
                          <ul class="ograshdenia-box__list">
                            <li class="ograshdenia-box__list-item">
                              Поручень - труба Ǿ38 мм. со стенкой 1,5 мм. из нержавеющей стали, зеркальная полировка;
                            </li>
                            <li class="ograshdenia-box__list-item">
                              Держатель поручня - нержавеющая сталь, зеркальная полировка;
                            </li>
                            <li class="ograshdenia-box__list-item">
                              Стойка - труба Ǿ38 мм. со стенкой 1,5 мм. из нержавеющей стали, зеркальная полировка;
                            </li>
                            <li class="ograshdenia-box__list-item">
                              Ригели 2 шт. на сварке – труба Ǿ12 мм. со стенкой 1,2 мм. из нержавеющей стали, зеркальная полировка;
                            </li>
                          </ul>
                        </div>
                        <div class="ograshdenia-box__item">
                          <img src="./images/ograshdenia/ograshdenia-2.jpg" alt="img" class="ograshdenia-box__item-img">
                          <div class="ograshdenia-box__item-text">
                            Ограждение из нержавеющей стали с 3 ригелями
                          </div>
                          <ul class="ograshdenia-box__list">
                            <li class="ograshdenia-box__list-item">
                              Поручень - труба Ǿ50,8 мм. со стенкой 1,5 мм. из нержавеющей стали, зеркальная полировка;
                            </li>
                            <li class="ograshdenia-box__list-item">
                              Держатель поручня - нержавеющая сталь, зеркальная полировка;
                            </li>
                            ...
                            <li class="ograshdenia-box__list-item">
                              Ригели 3 шт. на сварке – труба Ǿ16 мм. со стенкой 1,5 мм. из нержавеющей стали, зеркальная полировка
                            </li>
                          </ul>
                        </div>
                        <div class="ograshdenia-box__item">
                          <img src="./images/ograshdenia/ograshdenia-3.jpg" alt="img" class="ograshdenia-box__item-img">
                          <div class="ograshdenia-box__item-text">
                          ...
                          <ul class="ograshdenia-box__list">
                            ...
                            <li class="ograshdenia-box__list-item">
                              Заполнение – стекло закаленное толщиной 8 мм.
                            </li>
                            <li class="ograshdenia-box__list-item">
                              Держатель стекла - из нержавеющей стали, зеркальная полировка;
                            </li>
                          </ul>
                        </div>
                    </div>
